...
export default function FeaturedProjects() {
  return (
    <section className="relative py-4 pt-16 pb-16 mx-2 md:mx-6 overflow-hidden rounded-3xl z-10 shadow-[0_0_80px_30px_rgba(255,215,0,0.1)] before:absolute before:inset-0 before:-z-10 before:rounded-[inherit] before:bg-[radial-gradient(ellipse_100%_100%_at_50%_50%,rgba(120,119,198,0.6),transparent)] before:blur-3xl before:opacity-80">
