...
import WhatOurCustomers from "@/components/what-our-customers";
...
export default function Home() {
  return (
    <div className="space-y-20">
      ...
      <WhatOurCustomers />
      <ProfileCard />
      <section className="py-20 bg-header text-headerforeground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Start Your Dream Project?
          </h2>
          <p className="text-headerforeground/80 max-w-2xl mx-auto mb-8">
          ...
          <Button
            asChild
            size="lg"
            className="bg-white text-header hover:bg-white/90"
          >
